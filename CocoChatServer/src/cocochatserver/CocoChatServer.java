...
public class CocoChatServer{
    ...
    private static Terminal consola = new Terminal();
                    ...
                    switch (contexto) {
                            ...
                            if(message != null && usuarioReceptor != null)
                            {
                                for(Handler h : lista) //Navegar por la lista de clientes conectados
                                {
                                    if(h.usuario.equals(usuarioReceptor)) //Si algun nombre de cliente es igua al usuario enviado
                                    {
                                        ...
                                        consola.appendLog(this.usuario + " envio un mensaje a " + usuarioReceptor + ". Mensaje: " + message);
                                    }
                                }
                            }
                        ...
                        case "MessageFriend": //Si llega el String MessageFriend
                            ...
                            if(messageFriendConected != null && userFriendConected != null)
                            {
                                ...
                                msg.setMessage(messageFriendConected);
                                msg.setUserReceptor(conUserMessageFriend.buscarId(userFriendConected));
//                                System.out.println("Usuario que envia mensaje: " + conUserMessageFriend.buscarId(this.usuario));
//                                System.out.println(this.usuario);
                                msg.setUserEmisor(conUserMessageFriend.buscarId(this.usuario));
                                ...
                                for(Handler h : lista) //Se navega a traves de la lista de clientes
                                {
                                    if(h.usuario.equals(userFriendConected)) //Si el nombre del cliente es igual al nombre enviado
                                    {
                                        ...
                                        consola.appendLog(this.usuario + " envio un mensaje a Amigo " + userFriendConected + ". Mensaje: " + messageFriendConected);
                                    }
                                }
                            }
                            ...
                            break;
                        case "MessageFriendBD": //Si llega el String MessageFriendBD
                            ...
                            if(messageFriendNoConected != null && userFriendNoConected != null)
                            {
                                ...
                                MessagesUser msgNo = new MessagesUser(messageFriendNoConected,conUserMessageFriendNo.buscarId(this.usuario), conUserMessageFriendNo.buscarId(userFriendNoConected));
                                conMessageUSerMessageFriendNo.add(msgNo); //Se crea el Mensaje y se añade a la BD
                            }
                            consola.appendLog(this.usuario + " envio un mensaje a Amigo " + userFriendNoConected + ". Mensaje: " + messageFriendNoConected);
                            break;
                        case "InvitationsFriendsAccepted": //Si llega el String InvitationsFriendsAccepted
                            ...
                            if(userAcepted != null)
                            {
                                ...
                                consola.appendLog(this.usuario + " acepto solicitud de amisatad de " + userAcepted);
                            }
                        ...
                        case "InvitationsFriendsDenied": //Si llega el String InvitationsFriendsDenied
                            ...
                            if(userDenied != null)
                            {
                                ...
                                consola.appendLog(this.usuario + " rechazo solicitud de amisatad de " + userDenied);
                            }
                        ...
                        case "InvitationsFriendsSend": //Si llega el String InvitationsFriendsSend
                            ...
                            if(userSend != null)
                            {
                                ...
                                consola.appendLog(this.usuario + " envio solicitud de amisatad a " + userSend);
                            }
                        ...
                        case "MessageGroup": //Si llega el String MessageGroup
                            ...
                            if(messageGroup != null && groupMessage != null)
                            {
                                ...
                                consola.appendLog(this.usuario + " envio mensaje a Grupo " + groupMessage + ". Mensaje: " + messageGroup);
                            }
                        ...
                        case "CreatorGroup": //Si llega el String CreatorGroup
                            ...
                            if(nombre != null && descripcion != null && seleccion != null)
                            {
                                ...
                                consola.appendLog(this.usuario + " ha creado grupo " + nombre);
                                ...
                                for(String persona : seleccion.split(",")) //Se navega a traves de los usuarios en la seleccion de usuarios
                                {
                                    ...
                                    consola.appendLog(this.usuario + " ha invitado al grupo " + nombre + " a " + persona);
                                }
                        ...
                        case "InvitationGroup": //Si llega el String InvitationGroup
                            ...
                            if(grupoInvitado != null && usuariosInvitados != null)
                            {
                                ...
                                if(!grupoInvitado.equals("") || !usuariosInvitados.equals(""))
                                {
                                    ...
                                    for(String usuarioInv : usuariosInvitados.split(",")) //Se navega a traves de los usuarios
                                    {
                                        ...
                                        consola.appendLog(this.usuario + " ha invitado al grupo " + grupoInvitado + " a " + usuarioInv);
                                    }
                        ...
                        case "InvitationGroupAccept": //Si llega el String InvitationGroupAccept
                            ...
                            consola.appendLog(this.usuario + " ha acpetado la invitacion al grupo " + grupoInvitacion);
                            break;
                        case "InvitationGroupDenny": //Si llega el String InvitationGroupDenny
                            ...
                            consola.appendLog(this.usuario + " ha rechazado la invitacion al grupo " + grupoInvitacion2);
                            break;
                        case "DeleteGroup": //Si llega el String DeleteGroup
                            ...
                            consola.appendLog("Grupo " + grupoBorrado + " ha sido eliminado");
                            break;
                        case "DropDownGroup": //Si llega el String DropDownGroup
                            ...
                            consola.appendLog(this.usuario + " ha abandonado a Grupo " + dropDownGroup);
                            break;
                    }
        ...
        private void handleLogin(BufferedReader reader) throws IOException {
            ...
            consola.appendLog("Usuario " + usu + " ha ingresado");
        }
        ...
        private void handleRegister(BufferedReader reader) throws IOException {
            ...
            consola.appendLog("Usuario " + usuario + "se ha registrado");
        }
        ...
        private void handleLogout() throws IOException {
            ...
            consola.appendLog("Usuario " + this.usuario + " ha salido");
        }
        ...
        private void sendInvitationsGroups() throws IOException {
            for(Handler h : lista) //Se navega a traves de la lista de clientes
            {
                ...
                {
                    if(c.getUser() == conUser.buscarId(h.usuario) && c.getEstado().equals("D")) // Si el usuario en la invitacion y el usuario cliente y que su estado se Detenido
                    {
                ...
                System.out.println(h.usuario + " se le envian sus grupos" + listGroupsInvitation);
